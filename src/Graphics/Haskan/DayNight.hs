...
data DayNightConfig = DayNightConfig
  { dncMaxElevation :: Float    -- ^ Maximum sun elevation in radians (default: π/3 = 60°)
  , dncSunriseTime  :: Float    -- ^ Hour when sun rises (default: 6.0)
  , dncSunsetTime   :: Float    -- ^ Hour when sun sets (default: 18.0)
  , dncMaxIntensity :: Float    -- ^ Peak sun intensity at noon (default: 1.0)
  , dncNoonColor    :: V3 Float -- ^ Sun color at noon (default: white)
  , dncSunsetColor  :: V3 Float -- ^ Sun color at sunrise/sunset (default: warm orange)
  , dncDaySkyTint   :: V3 Float -- ^ Sky tint during day (default: white)
  , dncSunsetSkyTint :: V3 Float -- ^ Sky tint at sunset (default: orange)
  , dncNightSkyTint :: V3 Float -- ^ Sky tint at night (default: dark blue)
  , dncDayIBLIntensity :: Float -- ^ IBL intensity during day (default: 0.3)
  , dncNightIBLIntensity :: Float -- ^ IBL intensity at night (default: 0.05)
  }
  deriving (Show)
