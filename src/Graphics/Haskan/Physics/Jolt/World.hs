...
createWorld maxBodies maxPairs maxContacts =
  liftIO $
...
stepWorld (JoltWorld ptr) dt steps =
  liftIO $
...
removeBody (JoltWorld ptr) (BodyId bid) =
  liftIO $
...
setBodyPosition (JoltWorld ptr) (BodyId bid) (V3 x y z) =
  liftIO $
...
setBodyVelocity (JoltWorld ptr) (BodyId bid) (V3 x y z) =
  liftIO $
...
addBodyForce (JoltWorld ptr) (BodyId bid) (V3 x y z) =
  liftIO $
...
addBodyImpulse (JoltWorld ptr) (BodyId bid) (V3 x y z) =
  liftIO $
