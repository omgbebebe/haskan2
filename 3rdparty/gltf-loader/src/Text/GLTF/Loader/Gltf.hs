...
data Material = Material
  { -- | Specifies the cutoff threshold when in MASK alpha mode.
    ...
    materialNormalTexture :: Maybe TextureInfo,
    -- | The scalar multiplier applied to each normal vector of the normal texture.
    materialNormalScale :: Float,
    -- | The occlusion texture.
    materialOcclusionTexture :: Maybe TextureInfo,
    -- | The scalar multiplier controlling the amount of occlusion applied.
    materialOcclusionStrength :: Float
  } deriving (Eq, Show)
...
-- | The normal map texture.
_materialNormalTexture :: Lens' Material (Maybe TextureInfo)
_materialNormalTexture = lens
  materialNormalTexture
  (\material normalTex -> material { materialNormalTexture = normalTex })

-- | The scalar multiplier applied to each normal vector of the normal texture.
_materialNormalScale :: Lens' Material Float
_materialNormalScale = lens
  materialNormalScale
  (\material scale -> material { materialNormalScale = scale })

-- | The occlusion texture.
_materialOcclusionTexture :: Lens' Material (Maybe TextureInfo)
_materialOcclusionTexture = lens
  materialOcclusionTexture
  (\material occlusionTex -> material { materialOcclusionTexture = occlusionTex })

-- | The scalar multiplier controlling the amount of occlusion applied.
_materialOcclusionStrength :: Lens' Material Float
_materialOcclusionStrength = lens
  materialOcclusionStrength
  (\material strength -> material { materialOcclusionStrength = strength })
...
-- | The metallic-roughness texture.
_pbrMetallicRoughnessTexture :: Lens' PbrMetallicRoughness (Maybe TextureInfo)
_pbrMetallicRoughnessTexture = lens
  pbrMetallicRoughnessTexture
  (\pbr texture -> pbr { pbrMetallicRoughnessTexture = texture })
